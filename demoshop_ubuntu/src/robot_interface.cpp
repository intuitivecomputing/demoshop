...
void execute(const demoshop_ubuntu::ExecutePathGoalConstPtr& goal, Server* as)
{
    ...
    actionlib::SimpleActionClient<control_msgs::GripperCommandAction> gripper_ac("icl_gripper/gripper_cmd", true); // NOTE: Replace "icl_gripper/gripper_cmd" with the name of the action server corresponding to your robot's gripper
